...
public:
    ...
    void DrawPage(HWND hWnd, HDC hdc, RECT *rc, BOOL enable_alpha, alpha_dc_info_t *p_alpha_dc = NULL);
    void ReleaseAlphaTextBitmap(HDC hdc, alpha_dc_info_t *p_alpha_dc);
